...
void DefineObject(py::module& m) {
  ...
  py::class_<Object, std::shared_ptr<Object>>(m, "Object")
      ...
      .def_property("physics_simulated",  &Object::physics_simulated,
                    &Object::set_physics_simulated)
      ...
      .def_property_readonly("collision_type_veh", &Object::collision_type_veh)
      .def_property_readonly("collision_type_edge", &Object::collision_type_edge)
